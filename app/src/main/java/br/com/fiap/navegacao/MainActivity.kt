...
import br.com.fiap.navegacao.database.repository.ContatoRepository
...
fun ContatosScreen() {
    ...
    var amigoState by remember {
        mutableStateOf(false)
    }

    var listaContatosState by remember {
        mutableStateOf(listOf(Contato()))
       // mutableStateOf(contatoRepository.listarContatos())
    }

    listaContatosState = contatoRepository.listarContatos()
...
fun ContatoForm(
    ...
    Column(
        ...
        Button(
            onClick = {
                val contato = Contato( nome = nome, telefone = telefone, amigo =  amigo )
