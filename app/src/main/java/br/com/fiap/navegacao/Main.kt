...
fun ContatosScreen() {
    ...
    var listaContatosState = remember {
        mutableStateOf(contatoRepository.listarTodos())
    }
    ...
    Column {
        ContatoForm(
            ...
            atualizar = {
                listaContatosState.value = contatoRepository.listarTodos()
            }
        )
        ContatoList(
            listaContatosState,
            atualizar = {listaContatosState.value = contatoRepository.listarTodos()}
         )
    }
}
